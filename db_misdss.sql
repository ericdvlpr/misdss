...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 06, 2018 at 06:55 AM
...
(1, 1, 15234, 'out', '10:31:28', '06:15:32', '2017-12-30', '								\r\n							'),
(2, 1, 15234, 'out', '06:10:04', '06:15:32', '2017-12-30', '								\r\n							'),
(3, 3, 5628, 'out', '07:32:41', '07:32:51', '2018-01-06', '								\r\n							');
...
INSERT INTO `employee_details` (`employee_id`, `employee_name`, `employee_hrrate`, `employee_dlyrate`, `employee_perday`, `employee_passcode`, `employee_status`) VALUES
(1, 'Jerome Abonitaa', 50, 500, 8, 15234, 'Active'),
(2, 'Joseph Abonitaa', 5, 50, 8, 15234, 'Inactive'),
(3, 'Joseph Barameda', 8, 80, 8, 5628, 'Active');
...
INSERT INTO `payroll` (`id`, `employee_id`, `employee_name`, `hrsworked`, `daysworked`, `sss`, `pagibig`, `philhealth`, `netincome`, `monthof`) VALUES
(1, 1, 'Jerome Abonitaa', 5, 2, 800, 800, 800, 2500, 'January');
...
(1, 'john_smith@gmail.com', '$2y$10$3l2V43IqF8Avv2KUhhKAP.C9XPf3lZMDTNREhhFxdEkMX6Xw212Wq', 'Admin', 'master', 'Active'),
